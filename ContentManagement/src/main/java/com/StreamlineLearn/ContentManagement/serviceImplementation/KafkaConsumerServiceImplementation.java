...
import com.StreamlineLearn.ContentManagement.service.KafkaConsumerService;
...
public class KafkaConsumerServiceImplementation implements KafkaConsumerService {
    ...
    @Override
    @KafkaListener(topics = "course-details-topic", groupId = "content-management-group")
    ...
    @Override
    @KafkaListener(topics = "instructor-details-topic", groupId = "content-management-group")
