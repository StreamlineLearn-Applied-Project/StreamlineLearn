...
import com.StreamlineLearn.DiscussionService.service.KafkaConsumerService;
...
public class KafkaConsumerServiceImplementation implements KafkaConsumerService {
    ...
    @Override
    @KafkaListener(topics = "course-details-topic", groupId = "discussion-management-group")
    ...
    @Override
    @KafkaListener(topics = "instructor-details-topic", groupId = "discussion-management-group")
    ...
    @Override
    @KafkaListener(topics = "enrolledStudent-details-topic", groupId = "discussion-management-group")
