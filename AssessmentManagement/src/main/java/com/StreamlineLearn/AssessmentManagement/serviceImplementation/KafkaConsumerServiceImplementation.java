...
import com.StreamlineLearn.AssessmentManagement.service.KafkaConsumerService;
...
public class KafkaConsumerServiceImplementation implements KafkaConsumerService {
    ...
    @Override
    @KafkaListener(topics = "course-details-topic", groupId = "assessment-management-group")
