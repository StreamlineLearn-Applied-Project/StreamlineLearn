...
import {
  ...
  useRootElementName,
  useSlotProps
} from "./chunk-DG6KTNKV.js";
import {
  ThemeProvider_default,
  createCssVarsProvider,
  createGetCssVar,
  prepareCssVars_default
} from "./chunk-QZLWLTEW.js";
import {
  HTMLElementType,
  _extends,
...
function useSlider(parameters) {
  ...
  const touchId = React7.useRef();
  const [active, setActive] = React7.useState(-1);
  const [open, setOpen] = React7.useState(-1);
  const [dragging, setDragging] = React7.useState(false);
  const moveCount = React7.useRef(0);
  ...
  const [focusedThumbIndex, setFocusedThumbIndex] = React7.useState(-1);
  const sliderRef = React7.useRef();
  ...
  const previousIndex = React7.useRef();
  ...
  const stopListening = React7.useCallback(() => {
    const doc = ownerDocument(sliderRef.current);
...
function useSnackbar(parameters = {}) {
  ...
  const handleResume = React8.useCallback(() => {
...
true ? Button.propTypes = {
   ...
   * @default 'button'
   */
  rootElementName: import_prop_types7.default.string,
  /**
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime27.jsx)(React50.Fragment, {
...
var _excluded24 = ["checked", "defaultChecked", "disabled", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "slotProps", "slots"];
...
var _excluded30 = ["action", "children", "disabled", "onChange", "onClick", "onFocus", "slotProps", "slots", "value"];
...
var _excluded31 = ["children", "className", "enterAnimationName", "enterClassName", "exitAnimationName", "exitClassName"];
...
var _excluded32 = ["children", "className", "lastTransitionedPropertyOnExit", "enterClassName", "exitClassName"];
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YITSDSRF.js.map
